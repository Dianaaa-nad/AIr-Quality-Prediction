...
st.write("Welcome to real time air quality information website. We are dedicated to keeping you informed about the air you breathe and its impact on your health and well-being. Data are provided by BMKG. ")
...
filtered_o3 = o3_df[o3_df['day'] == current_date]
filtered_pm25 = pm25_df[pm25_df['day'] == current_date]
filtered_pm10 = pm10_df[pm10_df['day'] == current_date]
